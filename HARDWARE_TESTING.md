...
Thank you for testing Jabridge 1.0.0 RC7.
...
[v1.0.0-rc.7 preview](https://github.com/Watchdog0x/jabridge/releases/tag/v1.0.0-rc.7).

```bash
sha256sum -c jabridge_1.0.0-rc.7_linux_amd64.tar.gz.sha256
tar -xzf jabridge_1.0.0-rc.7_linux_amd64.tar.gz
cd jabridge_1.0.0-rc.7_linux_amd64
./jabridge --version
```
...
download completed, but missing `hidraw` permission blocked device reads. RC7
