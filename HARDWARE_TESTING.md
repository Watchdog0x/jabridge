...
Link route separately. RC22 implements the USB DFU transfer for the listed
Speak 410/510/710/810 profiles; actual flashes are not yet qualified. Separate
voluntary installation tests use [the USB DFU guide](https://github.com/Watchdog0x/jabridge/blob/codex/native-go-rewrite/docs/USB_DFU.md), not this
