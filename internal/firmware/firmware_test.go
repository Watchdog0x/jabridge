...
func TestValidateNativeCSRArchiveAcceptsPartitionedGnV(t *testing.T) {
	path := writeFirmwareArchiveFixture(t, fmt.Sprintf(`<buildVector version="1.2.3" productName="Test">
		<targetUsbPids><usbPid>0x1234</usbPid></targetUsbPids>
		<files>
			<file name="app.gnv"><partition>5</partition><crc>0x%08x</crc><language id="0x0409">English</language></file>
			<file name="footer.gnv"><partition>254</partition><crc>0x%08x</crc><language id="0x0409">English</language></file>
		</files>
	</buildVector>`, referenceStageCRC([]byte{1, 2, 3}), referenceStageCRC([]byte{4})), map[string][]byte{"app.gnv": {1, 2, 3}, "footer.gnv": {4}})
