...
var usbDFUProfiles = []usbDFUProfile{
	...
	// Exact catalog siblings and the DFU suffix/manifest target, not a PID range.
	// Direct USB preview; runtime descriptor/version and official release bytes
	// are checked again by the installer. Physical update/recovery is unqualified.
	{Name: "Jabra Evolve 75e", RuntimePIDs: []uint16{0x246c, 0x246d, 0x246e}, DFUPID: 0x097e, ReportID: 5},
}
