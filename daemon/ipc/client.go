...
func ClientFromConnection(conn net.Conn) *Client { return newClient(conn) }
...
func (client *Client) readLoop() {
	...
	for scanner.Scan() {
		...
		// Claim a pending call exactly once. Duplicate/late replies must not
		// fill its channel and stall every notification on this connection.
