...
var fixtureCallActive = []byte(`[
  ...
  {"id": 200, "type": "PipeWire:Interface:Node", "info": {
    "state": "running",
    "props": {"media.class": "Stream/Input/Audio", "application.name": "Firefox", "media.role": "Communication"}
  }},
  {"id": 300, "type": "PipeWire:Interface:Link", "info": {
    "output-node-id": 82, "input-node-id": 200, "state": "active"
  }}
]`)
...
var fixtureTeamsCall = []byte(`[
  ...
  {"id": 500, "type": "PipeWire:Interface:Node", "info": {
    "state": "running",
    "props": {"media.class": "Stream/Input/Audio", "application.name": "teams", "media.role": ""}
  }},
  {"id": 600, "type": "PipeWire:Interface:Link", "info": {
    "output-node-id": 73, "input-node-id": 500, "state": "active"
  }}
]`)
